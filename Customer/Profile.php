    ...
    <body>
        ...
        <div class="outer_frame">
            ...
            <div id="profile_update">
                <div>
                    <div class="input-data"><label>User Name : </label><input type="text" id="new_name"></div>
                    <div class="input-data"><label>User email : </label><input type="email" id="new_email" disabled=False></div>
                    <div class="input-data"><label>Contact : </label><input type="number" id="new_conno"></div>
                    <div class="input-data"><label>Gender : </label><select id="new_gender"><option value="Male">Male</option><option value="Female">Female</option></select></div>
                    <div class="input-data"><label>flat number : </label><input type="text" id="new_flat"></div>
                    <div class="input-data"><label>floor number : </label><input type="number" id="new_floor"></div>
                    <div class="input-data"><label>building name : </label><input type="text" id="new_building"></div>
                    <div class="input-data"><label>road street : </label><input type="text" id="new_road"></div>
                    <div class="input-data"><label>pincode : </label><input type="number" id="new_pincode"></div>
                    <div class="input-data"><label>State : </label><select id="new_state" onchange="fetch_city()"></select></div>
                    <div class="input-data"><label>City : </label><select id="new_city"></select></div>
                </div>
                <div>
